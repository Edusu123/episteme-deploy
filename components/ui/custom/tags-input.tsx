...
function Tag({ text, remove, disabled, className }: TagProps) {
  ...
  return (
    <span className="inline-flex items-center rounded bg-[#141d2f] px-2 py-2">
      ...
      {!disabled && (
        <button
          ...
          className="ml-2 cursor-pointer rounded-full border-0 bg-transparent text-[#f5f9fc] p-0 hover:text-neutral-400 hover:transition-colors"
        >
          &#10005;
        </button>
      )}
